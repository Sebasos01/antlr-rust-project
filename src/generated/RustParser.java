...
public class RustParser extends RustParserBase {
	...
	public final CrateContext crate() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1438304010365557336L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 127L) != 0) || _la==PATHSEP || _la==POUND) {
				{
				{
				setState(442);
				item();
	...
	public final MacroInvocationContext macroInvocation() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 5)) & ~0x3f) == 0 && ((1L << (_la - 5)) & -45017370590707711L) != 0) || ((((_la - 69)) & ~0x3f) == 0 && ((1L << (_la - 69)) & 576460752303423491L) != 0)) {
				{
				setState(452);
				simplePath();
				}
		...
		try {
			...
			case 1:
				...
				case LCURLYBRACE:
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
					if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1440555858902646752L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 1073741951L) != 0) || _la==PATHSEP || _la==LCURLYBRACE) {
						{
						setState(808);
						useTree();
						setState(813);
	...
	public final Trait_Context trait_() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1440555846015646424L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 127L) != 0) || _la==PATHSEP || _la==POUND) {
					{
					{
					setState(1221);
					associatedItem();
	...
	public final ExternBlockContext externBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1440555845881428696L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 127L) != 0) || _la==PATHSEP || _la==POUND) {
				{
				{
				setState(1348);
				externalItem();
